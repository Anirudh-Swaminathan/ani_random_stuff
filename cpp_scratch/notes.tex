...
\newcommand{\lecture}[4]{
   ...
   \framebox{
      \vbox{\vspace{2mm}
    \hbox to 6.28in { {\bf LearnCpp.org Notes
		\hfill Completed Parts + Summary} }
       \vspace{4mm}
       \hbox to 6.28in { {\Large \hfill Lecture 0  \hfill} }
       \vspace{2mm}
...
\section{Basic Intro to the Tutorials} % Don't be this informal in your notes!
...
\section{Machine Language, Assembly Language and High Level Language}
\section{Intro to C++}
\section{6 steps of development}
\section{Codeblocks Installation}
\section{Building Projects and Compiling Code}
\subsection{IDE build configurations}
\section{13 common C++ problems}
